...
--
-- Table structure for table `pdf1`
--

DROP TABLE IF EXISTS `pdf1`;
...
--
-- Dumping data for table `pdf1`
--

LOCK TABLES `pdf1` WRITE;
/*!40000 ALTER TABLE `pdf1` DISABLE KEYS */;
/*!40000 ALTER TABLE `pdf1` ENABLE KEYS */;
UNLOCK TABLES;
