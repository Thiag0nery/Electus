...
--
-- Table structure for table `pdf3`
--

DROP TABLE IF EXISTS `pdf3`;
...
--
-- Dumping data for table `pdf3`
--

LOCK TABLES `pdf3` WRITE;
/*!40000 ALTER TABLE `pdf3` DISABLE KEYS */;
/*!40000 ALTER TABLE `pdf3` ENABLE KEYS */;
UNLOCK TABLES;
